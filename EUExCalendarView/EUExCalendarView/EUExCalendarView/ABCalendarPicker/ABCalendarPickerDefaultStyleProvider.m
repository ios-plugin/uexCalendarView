...
- (UIFont *)titleFontForColumnTitlesVisible
{
    if (_titleFontForColumnTitlesVisible == nil)
        _titleFontForColumnTitlesVisible = [UIFont systemFontOfSize:23.0f];
...
- (UIFont *)titleFontForColumnTitlesInvisible
{
    if (_titleFontForColumnTitlesInvisible == nil)
        _titleFontForColumnTitlesInvisible = [UIFont systemFontOfSize:28.0f];
...
{
    if (_columnFont == nil)
        _columnFont = [UIFont systemFontOfSize:10.0f];
    return _columnFont;
}
...
- (UIFont *)tileTitleFont
{
    if (_tileTitleFont == nil)
        _tileTitleFont = [UIFont systemFontOfSize:24.0];
...
{
    if (_tileDotFont == nil)
        _tileDotFont = [UIFont systemFontOfSize:20.0];
    return _tileDotFont;
}
...
- (UIColor *)selectedTextColor
{
    if (_selectedTextColor == nil)
        _selectedTextColor = [EUtility ColorFromString:@"#e6533d"];
